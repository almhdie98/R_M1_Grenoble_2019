...
```{r ex6}
wbp_long %>% 
  spread(key = year, value = values) -> wdp_ex6
...
df %>% 
  ...
  ggplot(aes(x = year, y = prop, color = name)) + geom_line() +facet_grid(name~sex) -> plot
